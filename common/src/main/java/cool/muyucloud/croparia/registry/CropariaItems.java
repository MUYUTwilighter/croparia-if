...
public class CropariaItems {
    ...
    public static final RegistrySupplier<BlockItem> CROP_TRANSMUTER = registerItem(
        "crop_transmuter",
        properties -> new BlockItem(CropariaBlocks.CROP_TRANSMUTER.get(), properties.arch$tab(Tabs.MAIN))
    );
