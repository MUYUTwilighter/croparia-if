...
//    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(ResourceLocation.tryParse("croparia:ritual"), EmiIngredient.of(Ingredient.of(CropariaItems.RITUAL_STAND.get())));
//
...
//
//    public EmiRitualRecipe(RecipeHolder<RitualRecipe> holder) {
//        RitualRecipe recipe = holder.value();
//        this.id = holder.id();
//        this.ritual = EmiIngredient.of(Ingredient.of(recipe.getRitualItem()));
...
//        this.block = EmiIngredient.of(Ingredient.of(recipe.extractBlockItems().stream()));
//        this.inputs = List.of(ritual, block, ingredient);
...
//        widgets.addTexture(Constants.BLOCK_PLACE, centerX - 24, centerY + 8, 16, 16, 0, 0, 16, 16, 16, 16);
//        widgets.addTexture(EmiTexture.EMPTY_ARROW, centerX + 8, centerY + 8);
//    }
//}

@SuppressWarnings("unused")
public class EmiRitualRecipe {}